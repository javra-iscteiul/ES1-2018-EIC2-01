...
public class Email {
	...
	public static List<String> getTimeline() {
		try {
			...
			for (int i = 0; i < messages.length; i++) {
				...
				String s = "From: " + message.getFrom()[0] + "Subject: " + message.getSubject() + "Message: " + content;
				emails.add(s);
			}
			/*
			 * for (int i = 0 ; i < messages.length; i++) { Message message =
			 * messages[i];
			 * System.out.println("---------------------------------");
			 * System.out.println("Email Number " + (i + 1));
			 * System.out.println("Subject: " + message.getSubject());
			 * System.out.println("From: " + message.getFrom()[0]); String s =
			 * "Email Number " + (i + 1) + "Subject: " + message.getSubject() +
			 * "From: " + message.getFrom()[0]; System.out.println("Text: " +
			 * message.getContent().toString()); emails.add(s); }
			 */
			// Disconnect
	...
	public static void init() {
		...
		/*
		 * for(String email : getTimeline()){ Controller.getEmails().add(email);
		 ...
		 * properties.put("mail.pop3.starttls.enable", "true"); session =
		...
		try {
			...
			for (int i = 0; i < messages.length; i++) {
				...
				if (message.getSubject().contains(text) || content.contains(text)) {
					String s = "From: " + message.getFrom()[0] + "Subject: " + message.getSubject() + "Message: "
							+ content;
					emails.add(s);
				}
			}
